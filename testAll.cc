...
public:
  void testMake() {
    CPPUNIT_ASSERT_EQUAL(Ptype::makePtype(" . ", 0),
                         Ptype::makePtype(BLACK, Ptype::EMPTY));
    CPPUNIT_ASSERT_EQUAL(Ptype::makePtype("+HI", 0),
                         Ptype::makePtype(BLACK, Ptype::BABY));
    CPPUNIT_ASSERT_EQUAL(Ptype::makePtype("-HI", 0),
                         Ptype::makePtype(WHITE, Ptype::BABY));
    CPPUNIT_ASSERT_EQUAL(Ptype::makePtype("+ZO", 0),
                         Ptype::makePtype(BLACK, Ptype::ELEPHANT));
    CPPUNIT_ASSERT_EQUAL(Ptype::makePtype("-ZO", 0),
                         Ptype::makePtype(WHITE, Ptype::ELEPHANT));
    CPPUNIT_ASSERT_EQUAL(Ptype::makePtype("+KI", 0),
                         Ptype::makePtype(BLACK, Ptype::GIRAFFE));
    CPPUNIT_ASSERT_EQUAL(Ptype::makePtype("-KI", 0),
                         Ptype::makePtype(WHITE, Ptype::GIRAFFE));
    CPPUNIT_ASSERT_EQUAL(Ptype::makePtype("+NI", 0),
                         Ptype::makePtype(BLACK, Ptype::CHICKEN));
    CPPUNIT_ASSERT_EQUAL(Ptype::makePtype("-NI", 0),
                         Ptype::makePtype(WHITE, Ptype::CHICKEN));
    CPPUNIT_ASSERT_EQUAL(Ptype::makePtype("+LI", 0),
                         Ptype::makePtype(BLACK, Ptype::LION));
    CPPUNIT_ASSERT_EQUAL(Ptype::makePtype("-LI", 0),
                         Ptype::makePtype(WHITE, Ptype::LION));
  }
  void testPtypeChar() {
  ...
  void testMoveGen() {
    {
      ...
      // kirin drop moves
      CPPUNIT_ASSERT(find(moves.begin(), moves.end(), Move("+00A1KI")) !=
                     moves.end());
      CPPUNIT_ASSERT(find(moves.begin(), moves.end(), Move("+00B3KI")) !=
                     moves.end());
      CPPUNIT_ASSERT(find(moves.begin(), moves.end(), Move("+00B4KI")) !=
                     moves.end());
      CPPUNIT_ASSERT(find(moves.begin(), moves.end(), Move("+00C3KI")) !=
                     moves.end());
      CPPUNIT_ASSERT(find(moves.begin(), moves.end(), Move("+00C4KI")) !=
                     moves.end());
      // niwatori
      CPPUNIT_ASSERT(find(moves.begin(), moves.end(), Move("+A2A1NI")) !=
                     moves.end());
      CPPUNIT_ASSERT(find(moves.begin(), moves.end(), Move("+A2B1NI")) !=
                     moves.end());
      CPPUNIT_ASSERT(find(moves.begin(), moves.end(), Move("+A2B2NI")) !=
                     moves.end());
      CPPUNIT_ASSERT(find(moves.begin(), moves.end(), Move("+A2B3NI")) ==
                     moves.end());
      // zo
      CPPUNIT_ASSERT(find(moves.begin(), moves.end(), Move("+A3B2ZO")) !=
                     moves.end());
      CPPUNIT_ASSERT(find(moves.begin(), moves.end(), Move("+A3B4ZO")) !=
                     moves.end());
      // LION
      CPPUNIT_ASSERT(find(moves.begin(), moves.end(), Move("+A4B3LI")) !=
                     moves.end());
      CPPUNIT_ASSERT(find(moves.begin(), moves.end(), Move("+A4B4LI")) !=
                     moves.end());
    }
    {
      State s(" .  . -LI"
      ...
      CPPUNIT_ASSERT(find(moves.begin(), moves.end(), Move("-00C4KI")) !=
                     moves.end());
      CPPUNIT_ASSERT(find(moves.begin(), moves.end(), Move("-00B2KI")) !=
                     moves.end());
      CPPUNIT_ASSERT(find(moves.begin(), moves.end(), Move("-00B1KI")) !=
                     moves.end());
      CPPUNIT_ASSERT(find(moves.begin(), moves.end(), Move("-00A2KI")) !=
                     moves.end());
      CPPUNIT_ASSERT(find(moves.begin(), moves.end(), Move("-00A1KI")) !=
                     moves.end());
      // niwatori
      CPPUNIT_ASSERT(find(moves.begin(), moves.end(), Move("-C3C4NI")) !=
                     moves.end());
      CPPUNIT_ASSERT(find(moves.begin(), moves.end(), Move("-C3B4NI")) !=
                     moves.end());
      CPPUNIT_ASSERT(find(moves.begin(), moves.end(), Move("-C3B3NI")) !=
                     moves.end());
      CPPUNIT_ASSERT(find(moves.begin(), moves.end(), Move("-C3B2NI")) ==
                     moves.end());
      // zo
      CPPUNIT_ASSERT(find(moves.begin(), moves.end(), Move("-C2B3ZO")) !=
                     moves.end());
      CPPUNIT_ASSERT(find(moves.begin(), moves.end(), Move("-C2B1ZO")) !=
                     moves.end());
      // LION
      CPPUNIT_ASSERT(find(moves.begin(), moves.end(), Move("-C1B2LI")) !=
                     moves.end());
      CPPUNIT_ASSERT(find(moves.begin(), moves.end(), Move("-C1B1LI")) !=
                     moves.end());
    }
  }
  void testApplyMove() {
    {
      ...
      CPPUNIT_ASSERT(find(moves.begin(), moves.end(), Move("+A2A1NI")) !=
                     moves.end());
      CPPUNIT_ASSERT(find(moves.begin(), moves.end(), Move("+A2A1HI")) ==
                     moves.end());
